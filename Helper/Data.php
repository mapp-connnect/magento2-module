...
class Data extends AbstractHelper {
  ...
  function templateIdToConfig($templeteId) {
    $map = [
      ...
      "customer_create_account_email_no_password_template" => "mappconnect_messages/create_account/email_no_password_template",
      "customer_create_account_email_confirmation_template" => "mappconnect_messages/create_account/email_confirmation_template",
      "customer_create_account_email_confirmed_template" => "mappconnect_messages/create_account/email_confirmed_template",
      ...
      "customer_account_information_change_email_template" => "mappconnect_messages/account_information/change_email_template",
      "customer_account_information_change_email_and_password_template" => "mappconnect_messages/account_information/change_email_and_password_template",
